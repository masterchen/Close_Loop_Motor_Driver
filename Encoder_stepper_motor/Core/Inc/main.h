...
#define Encoder_steps_map 1  // 120 steps = 1 encoder value (1um)
#define Encoder_val_per_mm 1

#define steps_per_millimeters ( Encoder_steps_map * Encoder_val_per_mm)

//#define steps_per_millimeters 5
